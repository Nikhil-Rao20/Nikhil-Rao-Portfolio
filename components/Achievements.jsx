...
const Achievements = () => {
    ...
    // Ref for the achievements heading
    ...
    const handleToggleShowAll = () => {
        setShowAll(!showAll);
        // Scroll to the heading section when toggling to "Show Less"
        if (showAll && headingRef.current) {
            headingRef.current.scrollIntoView({ behavior: "auto" });
        }
    };

    return (
        <section className="xl:my-36 md:mx-36 p-8" id="achievements" ref={headingRef}>
            <div>
